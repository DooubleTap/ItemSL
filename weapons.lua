return {
	Weapons = {
		...
		['WEAPON_PISTOL'] = {
			...
			ammoname = 'ammo-9',
			weapClass = 'Classe 1',
			url = "https://cdn.discordapp.com/attachments/1125107270838140988/1125107279444852806/image.png",
		},
		...
		['WEAPON_GLOCK20'] = {
			...
			weight = 1700,
			durability = 0.03,
			ammoname = 'ammo-pistol9',
		},
		['WEAPON_SHIV'] = {
			label = 'Couteau homemade',
			weight = 500,
			durability = 0.03,
			ammoname = '',
		},
...
--[[ 		['at_glock20_flashlight'] = {
			label = 'Flashlight Glock20',
			type = 'flashlight',
			weight = 120,
			client = {
				component = {
